function DeveloperHero() {
    return (
        <div className="relative z-0">
            ...
            <div className="relative max-w-6xl mx-auto py-12 px-4 z-20">
                {/* Profile Section with enhanced styling */}
                <div className="flex flex-col md:flex-row items-center gap-12 relative">
                    <div className="w-48 h-48 rounded-full overflow-hidden ring-4 ring-blue-500/30 shadow-lg shadow-blue-500/20 relative z-20">
                        <img 
                    ...
                    <div className="text-white text-center md:text-left relative z-20">
                        <h1 className="text-4xl md:text-5xl font-bold mb-3 bg-clip-text bg-gradient-to-r from-white to-gray-300">Kasuma BaliDps</h1>
